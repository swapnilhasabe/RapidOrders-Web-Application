...
if ($retval === true)
{
    // Take Orderid as the key for Cache
    $key = $order_id;
    ...
    //$product = array('id' => $id, 'name' => $name, 'description' => $description, 'price' => $price);
	  $data[] = array('product ID::'=>$pr_code, 'Product Name'=>$pr_name,'Product Quantity'=>$pr_qty,'Product Price'=>$pr_price); 	
